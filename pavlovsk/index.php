            ...
            <div class="row">
                <div class="col-lg-3 benefit1 benefit container">
                    <div class="row">
                        ...
                        <p class="h-hint col-12 text-center mainBlueColor">Действительно низкие цены на переезд в Павловске</p>
                    </div>
                </div>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Светлана Новикова</h5>
                            <p class="text-left text-lg-center">
                                Спасибо вашей команде за профессионализм. Рабочие быстро провели переезд, совершенно не привлекая нас в работу. Мы очень вам благодарны за помощь.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд из Федоровского в Павловск
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Инна Дергачева</h5>
                            <p class="text-left text-lg-center">
                                Нам нужно было быстренько перевезти сыну на новую квартиру стиралку и парочку шкафов. Ваши ребята справились с задачей на отлично. И это при том, что нужно было сначала все спустить с 4-го этажа, а потом затащить на 6-й. Спасибо за помощь.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала перевозку мебели по Павловску
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Людмила Афанасьева</h5>
                            <p class="text-left text-lg-center">
                                Ваши ребята помогли нам перевезти солидное количество оборудования в новый офис без существенной потери рабочего времени. И это в самый разгар рабочего дня. Честно, не ожидала, что в наше время можно за недорого получить нормальное отношение.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала офисный переезд по Павловску
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Владимир Коваленков</h5>
                            <p class="text-left text-lg-center">
                                Я очень доволен проделанной работой. Переезд прошел четко по плану, начиная от расчета примерной стоимости и заканчивая сборкой мебели. Приятно иметь дело с профессионалами, которые относятся серьезно к своим обязанностям.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал квартирный переезд по Павловску
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Алексей Ярмольник</h5>
                            <p class="text-left text-lg-center">
                                Приятные цены, быстрое реагирование, пунктуальность, слаженность действий – все это нам предоставила ваша компания. Я думаю, лучшего помощника найти просто невозможно. Всем рекомендуют вашу компанию, как одну из лучших.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Иван Быков</h5>
                            <p class="text-left text-lg-center">
                                Мы заказывали обычную перевозку пианино с загородного дома в Павловск, но с уверенностью можем сказать, что ваша команда ответственно подходит к вопросу даже такого плана. Пианино доставили без царапин, упаковали надежно, машину подали вовремя.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал перевозку пианино из Тярлево в Павловск
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Руслана Троцкая</h5>
                            <p class="text-left text-lg-center">
                                Спасибо вашим рабочим за скорость и выносливость. Была удивлена, как быстро они погрузили тяжелые сейфы и оргтехнику, особенно учитывая демократичность ценника. Искренне рекомендую вашу компанию всем.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал офисный переезд по Павловску
                                    </i>
                                </p>
                            </div>
                        </div>

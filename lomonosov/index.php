            ...
            <div class="row">
                <div class="col-lg-3 benefit1 benefit container">
                    <div class="row">
                        ...
                        <p class="h-hint col-12 text-center mainBlueColor">Действительно низкие цены на переезд в Ломоносове</p>
                    </div>
                </div>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Лариса Кузьмина</h5>
                            <p class="text-left text-lg-center">
                                Если бы мы не обратились в вашу компанию, процесс переезда бы точно растянулся на целый день. А так вы проделали большую работу за каких то 4 часа. Спасибо вам. И отдельно спасибо менеджерам, которые помогли рассчитать расходы заранее.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала квартирный переезд по Ломоносову
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Анна Сайкова</h5>
                            <p class="text-left text-lg-center">
                                Ваши ребята работают на совесть. Я и оглянуться не успела, как все вещи были уложены в Газель. Очень порадовали тарифы. До этого пользовалась услугами другой компании, так вышло вдвое дороже.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала ночной переезд по Ломоносову
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Екатерина Бессонова</h5>
                            <p class="text-left text-lg-center">
                                Всем осталась довольна. Рабочие опытные, профессиональные. Машины новые, не битые. Вещи были упакованы качественно, соответственно ничего не поломалось в пути. Спасибо за прекрасную работу.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала офисный переезд по Ломоносову
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Владимир Никитин</h5>
                            <p class="text-left text-lg-center">
                                Мне очень понравилось работать с ребятами из «Переезд без хлопот». Очень ответственные, пунктуальные, делают все, что положено, аккуратно и без лишней спешки. С собой у них есть необходимые инструменты, что позволило мне ни за что не переживать.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд из Ломоносова в Сойкино
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Александр Кошелев</h5>
                            <p class="text-left text-lg-center">
                                Впервые воспользовался услугами мувинговой компании и не пожалел! Этот того стоило. Приехали, как и договаривались, быстро сложили все в машину, разложили по местам в новом доме. Огромное спасибо вашей фирме!
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал квартирный переезд из Ломоносова в Кукушкино
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Игорь Зеленский</h5>
                            <p class="text-left text-lg-center">
                                Говорят, если хочешь что-то сделать хорошо, сделай это сам, но это точно не о вашей компании. Не думал, что незнакомые люди способны трепетно переносить и укладывать мебель. А ваши грузчики делали именно так!
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал перевозку мебели из Малой Ижоры в Ломоносов
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Яна Никитенко</h5>
                            <p class="text-left text-lg-center">
                                Хочу поблагодарить компанию за оказанные услуги высокого уровня! Все прошло нормально, без заминок и затягивания времени. Рабочие– люди приятные, менеджеры отзывчивые. Таких бы компаний побольше.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала квартирный переезд из Большое Коновалово в Ломоносов
                                    </i>
                                </p>
                            </div>
                        </div>

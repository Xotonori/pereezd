            ...
            <div class="row">
                <div class="col-lg-3 benefit1 benefit container">
                    <div class="row">
                        ...
                        <p class="h-hint col-12 text-center mainBlueColor">Действительно низкие цены на переезд в Гатчина</p>
                    </div>
                </div>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Антонина Фесенко</h5>
                            <p class="text-left text-lg-center">
                                Выражаю благодарность всему коллективу вашей фирмы за столь непростую работу, которую вы так хорошо делаете. Мой переезд был организован четко и точно, все работали быстро, как хорошо отлаженный механизм. Вы действительно молодцы, желаю не снижать планку!
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">Заказывала переезд дома из Гатчины.</i>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Ирина Чугаева</h5>
                            <p class="text-left text-lg-center">
                                Ребята такие молодцы, просто слов нет! Огромное вам спасибо и за помощь в организации моего переезда, и за такое приятное общение, и за то, что вошли в мою ситуацию. Действительно, профессиональная работа и человеческое отношение!
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">Заказывала переезд двухкомнатной квартиры в Гатчине.</i>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Татьяна Семистрок</h5>
                            <p class="text-left text-lg-center">
                                Все мои вещи были перевезены быстро и очень аккуратно. Отдельное спасибо за коробки для упаковки – раньше всегда приходилось их неделями до переезда собирать)) Всем довольна, цена более чем устроила. Большое спасибо, буду еще обращаться.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд вещей и мебели на дачу в Гатчине.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Андрей Ермаков</h5>
                            <p class="text-left text-lg-center">
                                Ваша помощь при переезде моего офиса оказалась неоценимой! С моим женским коллективом мы бы сами никак не справились с перевозкой всех вещей, да и времени ушло бы явно больше. Особо благодарен за помощь в расстановке мебели на месте. Большое спасибо.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд офиса в Гатчине.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Игорь Кондратей</h5>
                            <p class="text-left text-lg-center">
                                Мне понравилось, как бригада работала - быстро, слаженно. Вывезли мебель с вещами буквально за пару часов, на месте все оперативно разгрузили. Водитель очень аккуратный попался, довез все без осложнений. Спасибо, рад, что переезжал с вами.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд однокомнатной квартиры в Гатчину.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Владимир Вдовенко</h5>
                            <p class="text-left text-lg-center">
                                Это был мой первый опыт переезда с профессиональной командой и, думаю, не последний. Всем очень доволен, действительно значительно быстрей выходит, проще, без нервов и кучи проблем. Спасибо за оказанную помощью.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд треххкомнатной квартиры в Гатчину.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Олеся Руденок</h5>
                            <p class="text-left text-lg-center">
                                Впервые пришлось организовывать переезд самой, без мужа, и хорошо, что мне посоветовали вашу фирму. Как и обещали, все прошло без хлопот: позвонила, все объяснила, и в конце отдала оговоренную сумму. И все!!! Не беспокоилась ни о чем, не волновалась, даже время на сбор вещей тратить не пришлось. Очень довольна.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд двухкомнатной квартиры в Гатчине.
                                    </i>
                                </p>
                            </div>
                        </div>

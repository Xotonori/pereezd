                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Наталья Веремейчик</h5>
                            <p class="text-left text-lg-center">
                                Всегда приятно работать с фирмами, где уважают клиентов и где действительно профессионалы работают. Большущее спасибо и за оперативный переезд, и за человеческое отношение – сейчас это редкость.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд однокомнатной квартиры по Колпино.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Надежда Дедуш</h5>
                            <p class="text-left text-lg-center">
                                Обратилась к вам по совету сестры и не прогадала. Условия переезда действительно точно соответствовали описанию на сайте, грузчики сразу видно опытные, машины со специальными крепежами, все работают слаженно и четко. Очень довольна.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд двухкомнатной квартиры в Колпино.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Людмила Черныш</h5>
                            <p class="text-left text-lg-center">
                                Всеми выполненными работами (заказывала и упаковку вещей в том числе) полностью довольна, стоимость оказалась вполне доступной. Грузчики профессиональные, быстрые, вежливые, транспорт чистый, приехали вовремя. Спасибо.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд трехкомнатной квартиры в Колпино.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Игорь Савчук</h5>
                            <p class="text-left text-lg-center">
                                Благодарю за хорошую работу, за быстрый переезд. К вещам во время перевозки относились бережно, ничего не бросали, все целое доехало. Ребята разбирали шкаф для перевозки, собрали на новой квартире, теперь дверка не скрипит) Профессионалы)
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд трехкомнатной квартиры из Колпино в Павловск.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Ярослав Овчарук</h5>
                            <p class="text-left text-lg-center">
                                Переезд – это всегда стресс, но в этот раз он был минимизирован благодаря участию вашей компании. Спасибо, ребята, что так мне помогли, да еще и согласились поздним вечером работать и в не лучших погодных условиях. Вы реально молодцы!
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд офиса в Колпино.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Анатолий Геращенко</h5>
                            <p class="text-left text-lg-center">
                                Обратился именно в «Переезд без хлопот» из-за привлекательных цен. В результате оказалось, что и качество работ тут также отличное! Отмечу, что все предварительные договоренности, озвученные по телефону, были выполнены исполнителями на сто процентов. В общем, можно доверять компании.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд однокомнатной квартиры из Колпино в Никольское.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Лера Васильевская</h5>
                            <p class="text-left text-lg-center">
                                Оценила масштаб переезда и поняла, что сама не справлюсь. Вашу фирму нашла в интернете – мне понравилась стоимость и набор услуг. В результате все вышло даже лучше, чем я ожидала! Я, конечно, тоже поучаствовала в подготовке переезда, но это не стоило мне нервов и кучи времени. В общем, очень довольна и спасибо огромное.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд дома из Колпино.
                                    </i>
                                </p>
                            </div>
                        </div>

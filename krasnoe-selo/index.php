            ...
            <div class="row">
                <div class="col-lg-3 benefit1 benefit container">
                    <div class="row">
                        ...
                        <p class="h-hint col-12 text-center mainBlueColor">Действительно низкие цены на переезд в Красном Селе</p>
                    </div>
                </div>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Маргарита Бережная</h5>
                            <p class="text-left text-lg-center">
                                Несмотря на то, что мне из-за болезни пришлось переносить переезд, в итоге он прошел отлично. Большое спасибо, что вошли в мое положение. Ребята грузчики хорошие, помогли нам все упаковать, разобрали наши многочисленные шкафы, потом собрали их на месте. В общем, без претензий, только с благодарностями!
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд двухкомнатной квартиры в Красном Селе.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Светлана Туринская</h5>
                            <p class="text-left text-lg-center">
                                Имея несколько негативных воспоминаний о переездах как самостоятельно, так и с фирмами, несколько настороженно относилась к «Переезду без Хлопот». Но посоветовали мне вас люди, заслуживающие доверия, и вы действительно меня не разочаровали и не подвели!Спасибо, что возродили мою веру в мувинговые услуги))
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Богдана Кабацкая</h5>
                            <p class="text-left text-lg-center">
                                Ваши ребята - действительно профессионалы своего дела. Приехали точно по графику, аккуратнейшим образом сносили все вещи и мои цветочки, не знаю как, но довезли их все целенькими! Очень благодарна!! Молодцы.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Антон Клыманский</h5>
                            <p class="text-left text-lg-center">
                                Выполненной работой доволен, переезд состоялся. Спасибо за то, что согласились организовать его без предварительной договоренности – все решилось в последний момент. Подход к работе действительно профессиональный.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд однокомнатной квартиры-студии в Красном Селе.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Михаил Дидковский</h5>
                            <p class="text-left text-lg-center">
                                Услугами «Переезда без хлопот» доволен на все сто. Очень ценю, когда люди работают в соответствии с договоренностью. Заказанная машина прибыла вовремя, все оговоренные услуги были предоставлены, вещи довезены в целости, заплатил как договаривались. Так держать.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд трехкомнатной квартиры из Красного Села в Сестрорецк.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Артур Медведев</h5>
                            <p class="text-left text-lg-center">
                                Это был мой первый самостоятельный переезд, и я рад, что воспользовался вашими услугами. Спасибо за все, особенно за помощь в демонтаже и сборе мебели и техники, я сам в этом не силен. И да, переезжать не сложно! Поверьте!
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд однокомнатной квартиры в Красном Селе.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Иванна Матвеева</h5>
                            <p class="text-left text-lg-center">
                                Приношу вам от всей души благодарность за прекрасно организованный переезд. Мне самой сейчас этим вообще некогда заниматься, и без вас я бы просто не справилась. Очень рада, что не стала жадничать и переезжать своими силами – вышло бы дольше и, пожалуй, дороже.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд домав Красном Селе.
                                    </i>
                                </p>
                            </div>
                        </div>

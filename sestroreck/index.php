            ...
            <div class="row">
                <div class="col-lg-3 benefit1 benefit container">
                    <div class="row">
                        ...
                        <p class="h-hint col-12 text-center mainBlueColor">Действительно низкие цены на переезд в Сестрорецке</p>
                    </div>
                </div>
            ...
            <div id="recommendationCaption1" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            ...
                            <p class="text-left text-lg-center">
                                Хороший сервис, отличная работа грузчиков, приятные менеджеры на телефоне. Просто приятно наблюдать, как работают профессионалы – можно как кино смотреть! С деньгами рассталась безо всяких сожалений – действительно, заработали!
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд трехкомнатной квартиры в Сестрорецке.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Жанна Тинчурина</h5>
                            <p class="text-left text-lg-center">
                                Когда мне поручили организовать переезд офиса, думала, что это будет для меня сущим кошмаром. Но к счастью обнаружила номер вашей компании, куда пару лет назад обращалась, и вы снова не подвели. Огромнейшее спасибо за хорошую работу! Шеф доволен))
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд офисав Сестрорецке.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Катерина Самохина</h5>
                            <p class="text-left text-lg-center">
                                Хорошо, что есть компании, которым можно доверить все, что нажито за долгие годы! Я очень довольна вашей работой, хотя и сомневалась, правда ли все так хорошо, как в отзывах пишут. Справились с переездом на 5 с огромным плюсом!
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд на дачу Сестрорецке.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Михаил Репех</h5>
                            <p class="text-left text-lg-center">
                                Пользовался услугами этой компании впервые, сначала был приятно удивлен опрятным видом грузчиков, потом и качеством того, как они работали. Погрузили действительно быстро, не нужно было над душой у ребят стоять, подгонять их. Хорошая работа.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд двухкомнатной квартиры из Сестрорецка во Всеволожск.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Дмитрий Лынник</h5>
                            <p class="text-left text-lg-center">
                                Спасибо за перевозку моих вещей в таком оперативном режиме. Ко всем вещам относились аккуратно, ничего не поцарапали. Шкаф и диван пришлось разбирать и потом собирать – все нормально, не разваливается пока. Цена устроила.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд вещейв Сестрорецке.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Никита Горицкий</h5>
                            <p class="text-left text-lg-center">
                                Оценил, что стоимость переезда после его проведения не меняется – какую сказали сумму сразу, такую и взяли. А то был у меня печальный опыт с одной питерской фирмой(( А здесь все отлично прошло, еще и стоимость невысокая – молодцы, спасибо за работу.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд двухкомнатной квартиры в Сестрорецке.
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Алена Кравецкая</h5>
                            <p class="text-left text-lg-center">
                                Расскажу о моем переезде: машина прибыла вовремя и, что порадовало, она была чистенькая, вымытая внутри (ну приятно же!). Грузчики адекватные, вежливые, видно, что профессионалы. Погрузили-разгрузили быстро, не повредили мои цветы при перевозке. Хорошая фирма, рекомендую.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд однокомнатной квартиры в Сестрорецке.
                                    </i>
                                </p>
                            </div>
                        </div>

<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part1.php'); ?>
    <meta name="description" itemprop="description" content="Шасимарданов М. И. - видео отзывы клиентов компании Переезд без хлопот в Санкт-Петербурге" />
                ...
                <div class="col-11 js-long-text container how-much-description mt-4">
                    <div class="row">
                        <p class="col-12 paragraph pt-0">
                            Здравствуйте, меня зовут Марс, у нас в семье возникла необходимость с временным хранением вещей. При поиске компании в интернете нашли «Переезд Без Хлопот», обратились сюда, нам подошли и цены и варианты по хранению и перевозке вещей. Приехала группа перевозчиков, вовремя, могу отметить профессиональный подход, все было качественно и оперативно упаковано, загружено, своевременно привезено на склад и упаковано в систему хранения. Могу подтвердить профессионализм ребят.
                        </p>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center">
                            <iframe width="753px" height="446px" src="https://www.youtube.com/embed/g9oZ9Hv0yqw?rel=0&amp;enablejsapi=1" allowfullscreen="" frameborder="0"></iframe>
                        </div>
                    </div>

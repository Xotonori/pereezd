<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part1.php'); ?>
    <meta name="description" itemprop="description" content="Успенская Е. - видео отзывы клиентов компании Переезд без хлопот в Санкт-Петербурге" />
    <meta name="keywords" itemprop="keywords" content="" />
    <title>Успенская Е. - видео отзывы - Переезд без хлопот в Санкт-Петербурге</title>
    <link rel="canonical" href="https://pereezdy-spb.ru/video_reference/uspenskaya/" />
...
<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part3.php'); ?>
    <h1>Успенская Е., Санкт-Петербург</h1>
                ...
                <div class="col-11 js-long-text container how-much-description mt-4">
                    <div class="row">
                        <p class="col-12 paragraph pt-0">
                            Успенская Екатерина. Переезжаем в связи со сменой квартир. Со съемной на свою. Необходимо временно похоронить все вещи, пока квартира доремонтируется. Очень удобно. Порекомендовала фирма, где складирую вещи, оказалась очень удобная услуга, о которой, я в общем то не знала. Ребята все привезли и клей, и скотч, и клеенки, и коробки. Надо было только вытащить вещи из шкафов. И все упаковали, все сами быстро очень хорошо все вынесли. Никаких проблем. Спасибо.
                        </p>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center">
                            <iframe width="753px" height="446px" src="https://www.youtube.com/embed/YUHf6XEkAHY?rel=0&amp;enablejsapi=1" allowfullscreen="" frameborder="0"></iframe>
                        </div>
                    </div>

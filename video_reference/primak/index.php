<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part1.php'); ?>
    <meta name="description" itemprop="description" content="Примак О. - видео отзывы клиентов компании Переезд без хлопот в Санкт-Петербурге" />
    <meta name="keywords" itemprop="keywords" content="" />
    <title>Примак О. - видео отзывы - Переезд без хлопот в Санкт-Петербурге</title>
    <link rel="canonical" href="https://pereezdy-spb.ru/video_reference/primak/" />
...
<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part3.php'); ?>
    <h1>Примак О., Санкт-Петербург</h1>
                ...
                <div class="col-11 js-long-text container how-much-description mt-4">
                    <div class="row">
                        <p class="col-12 paragraph pt-0">
                            Здравствуйте! Меня зовут Примак Олеся. Мы переезжаем в квартиру, в связи с ее покупкой, и обратились в компанию «Переезд без хлопот». И, как вы видите, сегодня мы отпразднуем это знаменательное событие. К ребятам обратились, потому что до этого уже пользовались их услугами. Остались очень довольны. Хочу сказать огромное спасибо им за то, что перевезли все в кратчайшие сроки, очень мобильно, быстро, доступно. Не поцарапали мне ни одной стены ни в подъезде не в квартире. Спасибо большое. Желаю успехов.
                        </p>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center">
                            <iframe width="753px" height="446px" src="https://www.youtube.com/embed/ItAj4x1QFjA?rel=0&amp;enablejsapi=1" allowfullscreen="" frameborder="0"></iframe>
                        </div>
                    </div>

<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part1.php'); ?>
    <meta name="description" itemprop="description" content="Лебедь К. - видео отзывы клиентов компании Переезд без хлопот в Санкт-Петербурге" /
    <meta name="keywords" itemprop="keywords" content="" />
    <title>Лебедь К. - видео отзывы - Переезд без хлопот в Санкт-Петербурге</title>
    <link rel="canonical" href="https://pereezdy-spb.ru/video_reference/lebed/" />
...
<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part3.php'); ?>
    <h1>Лебедь К., Санкт-Петербург</h1>
                ...
                <div class="col-11 js-long-text container how-much-description mt-4">
                    <div class="row">
                        <p class="col-12 paragraph pt-0">
                            Здравствуйте, я Лебедь Константин.Мы затеяли переезд в связи с покупкой новой квартиры, обратились в компанию «Мобиус», соответственно, к ее перевозчикам «Переезд Без Хлопот» для оперативного размещения и перевозки нашей мебели. Работа была выполнена хорошо, люди очень аккуратно собрали мебель, быстро ее погрузили и доставили. Всем рекомендую воспользоваться их услугами.
                        </p>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center">
                            <iframe width="753px" height="446px" src="https://www.youtube.com/embed/yfbJ0MNT-bQ?rel=0&amp;enablejsapi=1" allowfullscreen="" frameborder="0"></iframe>
                        </div>
                    </div>

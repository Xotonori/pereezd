<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part1.php'); ?>
    <meta name="description" itemprop="description" content="Клеймович А. А. , - видео отзывы клиентов компании Переезд без хлопот в Санкт-Петербурге" />
    <meta name="keywords" itemprop="keywords" content="" />
    <title>Клеймович А. А. - видео отзывы - Переезд без хлопот в Санкт-Петербурге</title>
    <link rel="canonical" href="https://pereezdy-spb.ru/video_reference/kleymovich/" />
...
<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part3.php'); ?>
    <h1>Клеймович А. А. , САНКТ-ПЕТЕРБУРГ</h1>
                ...
                <div class="col-11 js-long-text container how-much-description mt-4">
                    <div class="row">
                        <p class="col-12 paragraph pt-0">
                            Меня зовут Александр решил обратится в компанию Мобиус в связи с тем что переезжаем в другую квартиру пока будем делать ремонт в новой. По этому выбрали оптимальное решение по складскому хранению, удобно подъехать, сразу можно разгрузится, в любое время можно приехать что то доложить, цена меня тоже устроила, и скидку дали предновогоднюю. Ребята посоветовали сразу оформить машину, все быстро собрали помогли упаковать все сделали профессионально, очень остался доволен. Лучше не бывает, всем советую, обращайтесь не пожалеете.
                        </p>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center">
                            <iframe width="753px" height="446px" src="https://www.youtube.com/embed/aYVdMlAuFfI?rel=0&amp;enablejsapi=1" allowfullscreen="" frameborder="0"></iframe>
                        </div>
                    </div>

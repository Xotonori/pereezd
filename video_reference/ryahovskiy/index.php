<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part1.php'); ?>
    <meta name="description" itemprop="description" content="Ряховский А.С. - видео отзывы клиентов компании Переезд без хлопот в Санкт-Петербурге" />
    <meta name="keywords" itemprop="keywords" content="" />
    <title>Ряховский А.С. - видео отзывы - Переезд без хлопот в Санкт-Петербурге</title>
    <link rel="canonical" href="https://pereezdy-spb.ru/video_reference/ryahovskiy/" />
...
<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part3.php'); ?>
    <h1>Ряховский А.С., Санкт-Петербург</h1>
                ...
                <div class="col-11 js-long-text container how-much-description mt-4">
                    <div class="row">
                        <p class="col-12 paragraph pt-0">
                            Здравствуйте, меня зовут Александр, я работаю в сфере маркетинга.В связи с тем, что переезжаю на другую квартиру, нужно было где-то оставить все вещи со своей предыдущей квартиры на полгода. Просмотрев несколько компаний, которые предоставляют услуги по ответственному хранению, по каким-то причинам, скорее всего исходя из сайта, больше всего вызвала доверия компания «Мобиус». В итоге приехали грузчики компании «Переезд Без Хлопот», запаковали мне вещи, сами их привезли, умудрились складировать в контейнер так, как в общем никто не предполагал — гораздо меньше, чем было по виду. Спасибо!
                        </p>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center">
                            <iframe width="753px" height="446px" src="https://www.youtube.com/embed/jnFz1Nx4BLU?rel=0&amp;enablejsapi=1" allowfullscreen="" frameborder="0"></iframe>
                        </div>
                    </div>

<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part1.php'); ?>
    <meta name="description" itemprop="description" content="Хафман Е. Н. , - видео отзывы клиентов компании Переезд без хлопот в Санкт-Петербурге" />
    <meta name="keywords" itemprop="keywords" content="" />
    <title>Хафман Е. Н. - видео отзывы - Переезд без хлопот в Санкт-Петербурге</title>
    <link rel="canonical" href="https://pereezdy-spb.ru/video_reference/hafman/" />
...
<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part3.php'); ?>
    <h1>Хафман Е. Н. , САНКТ-ПЕТЕРБУРГ</h1>
                ...
                <div class="col-11 js-long-text container how-much-description mt-4">
                    <div class="row">
                        <p class="col-12 paragraph pt-0">
                            Я Екатерина Хафман, обратилась в компанию «Переезд Без Хлопот», потому что Мобиус посоветовал, и мы не пожалели, потому как раньше сталкивались с другими компаниями, которые перевозили вещи и все время пытались как то обмануть либо выманить деньги либо поменять тарифы. Здесь пришли очень интеллигентные мужчины быстро и аккуратно перевезли все вещи, мне очень понравилось. Рекомендую!
                        </p>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center">
                            <iframe width="753px" height="446px" src="https://www.youtube.com/embed/q7LJdq_C4mI?rel=0&amp;enablejsapi=1" allowfullscreen="" frameborder="0"></iframe>
                        </div>
                    </div>

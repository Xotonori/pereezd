<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part1.php'); ?>
    <meta name="description" itemprop="description" content="Мелинти С. - видео отзывы клиентов компании Переезд без хлопот в Санкт-Петербурге" />
    <meta name="keywords" itemprop="keywords" content="" />
    <title>Мелинти С. - видео отзывы - Переезд без хлопот в Санкт-Петербурге</title>
    <link rel="canonical" href="https://pereezdy-spb.ru/video_reference/melinti/" />
...
<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part3.php'); ?>
    <h1>Мелинти С., Санкт-Петербург</h1>
                ...
                <div class="col-11 js-long-text container how-much-description mt-4">
                    <div class="row">
                        <p class="col-12 paragraph pt-0">
                            Добрый вечер! Меня зовут Сергей. Мы организовали переезд в связи со сменой квартиры. Соответственно, мы много подыскивали фирм, специализируемых по перевозу, выбрали «Переезд без хлопот». Значит, ребята квалифицированные, помогли все нам оформить, помогли рассчитать, объем транспорта, по весу, по упаковке, что чего надо. Соответственно, заблаговременно все упаковали, разобрали и перевезли. Вот, все компактно, ничего не пострадало при переезде. Всем рекомендую обращаться в « Переезд без хлопот».
                        </p>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center">
                            <iframe width="753px" height="446px" src="https://www.youtube.com/embed/erLcoav6ft4?rel=0&amp;enablejsapi=1" allowfullscreen="" frameborder="0"></iframe>
                        </div>
                    </div>

<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part1.php'); ?>
    <meta name="description" itemprop="description" content="Коробковский А.Ю. - видео отзывы клиентов компании Переезд без хлопот в Санкт-Петербурге" />
    <meta name="keywords" itemprop="keywords" content="" />
    <title>Коробковский А.Ю. - видео отзывы - Переезд без хлопот в Санкт-Петербурге</title>
    <link rel="canonical" href="https://pereezdy-spb.ru/video_reference/korobkovskiy/" />
...
<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part3.php'); ?>
    <h1>Коробковский А.Ю., Санкт-Петербург</h1>
                ...
                <div class="col-11 js-long-text container how-much-description mt-4">
                    <div class="row">
                        <p class="col-12 paragraph pt-0">
                            Добрый день, меня зовут Антон, я занимаюсь банковской деятельностью, возникла необходимость в переезде. Обратился к знакомым, друзья посоветовали компанию «Переезд Без Хлопот». Я посмотрел в интернете сайт, в ВКонтакте и решил воспользоваться, обратился к ребятам. Перевезли вещи очень быстро, оперативно, все здорово, все супер. Всем советую! Надеюсь, что при обратном переезде ребята также мне помогут быстро и оперативно перевезти мои вещи.
                        </p>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center">
                            <iframe width="753px" height="446px" src="https://www.youtube.com/embed/z4dan7yMX-k?rel=0&amp;enablejsapi=1" allowfullscreen="" frameborder="0"></iframe>
                        </div>
                    </div>

...
<meta name="description" itemprop="description" content="Профессиональный переезд магазина от компании Переезд Без Хлопот в Санкт-Петербурге" />
...
<button type="button" class="request-call" data-toggle="modal" data-target="#header-modal">Заказать переезд магазина</button>
...
<main>
            ...
            <div class="col-11 js-long-text container how-much-description">
                <div class="row">
                    <p class="col-12 paragraph">
                        Компания «Переезд без хлопот» предлагает одну из наиболее востребованных услуг в сфере транспортных перевозок – переезд магазина в Санкт-Петербурге. Благодаря слаженной профессиональной команде, обширному автопарку и большому выбору упаковочных материалов мы в короткие сроки сможем осуществить перевозкукак небольшого магазина, так и крупного супермаркета с полной гарантией целостности вверенного нам имущества.В комплекс услуг входят работы по демонтажу и транспортировке тяжелого торгового оборудования, сборке/разборке мебели, упаковке, такелажу негабарита и т.д.
                    </p>
            ...
            <div class="col-12">
                <ul>
                    <li><b>Бесплатный выезд менеджера</b>.
                        Специалист компании осмотрит площадь магазина, имущество, которое требуется перевезти, и составит полный список всех необходимых вам услуг.При осмотре особое внимание уделяется таким деталям какрасположение магазина (этаж), наличие лифтов, возможность подъездов к зданию и др.</li>
                    <li><b>Составление плана работ</b>.
                        В подробный план предстоящего переезда входит расчет общего объема грузов, количества необходимых для их перевозки упаковочных материалов и транспортных средств. В зависимости от веса, размеров и характера отдельных предметов подбирается подходящая спецтехника: Газели типа тент и фургон (грузоподъемность до 1,5 т), Зил Бычок (5 т) или длинномерные тентованные фуры (до 20 т). После этого происходит расчет нужного количества специалистов: грузчиков, такелажников и водителей. Исходя из сложности переезда и пожеланий заказчика, определяются сроки проведения работ.</li>
                    <li><b>Оценка стоимости переезда</b>.
                        Составляется подробная смета с определением окончательной стоимости услуг. Она согласовывается с заказчиком, после чего прописывается в договоре.</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h3>Профессиональный переезд магазина</h3>
            </div>
            <p class="col-12">
                После утверждения плана мероприятия и подписания сторонами договора начинается непосредственный переезд магазина.В него входят следующие работы:
            </p>
            <div class="col-12">
                <ol>
                    <li>Доставка упаковочных материалов (картонных контейнеров, воздушно-пузырчатой и стрейч пленки, скотча и пр.).</li>
                    <li>Разборка мебели, крупногабаритного торгового оборудования и стеллажей с привлечением опытных специалистов по демонтажу и применением необходимых инструментов.</li>
                    <li>Маркировка и упаковка имущества. Упаковка хрупких и особо ценных предметов (витрин, стекол, зеркал, офисной техники) происходит особо тщательно и аккуратно.</li>
                    <li>Такелаж большеразмерных и тяжелых предметов: холодильных и кассовых установок, сейфов, банкоматов и пр. с использованием тележек, строп и других приспособлений.</li>
                    <li>Погрузка имущества на спецтехнику, транспортировка и разгрузка на новом месте.</li>
                </ol>
            </div>
        </div>
    </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="videoModal1-title">Переезд магазина</h5>
                                ...
                                <div class="modal-body">
                                    <iframe class="w-100 h-100" src="https://www.youtube.com/embed/VDuenUfKq1g?rel=0&enablejsapi=1" frameborder="0" allowfullscreen id="Youtube1"></iframe>
                                    <script>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p>На завершающем этапе переезда выполняется монтаж мебели и оборудования, подключение офисной техники, уборка и вывоз мусора. Заказать переезд магазина можно по телефонам: +7 (812) 982-88-58, +7 (961) 801-88-81 или через онлайн-форму на нашем сайте.</p>
            </div>
        </div>
    </div>
    <!--////photos////////////////////////////////////////////////////////////////////////////////////////////////-->
        ...
        <div class="row">
            <div class="carousel-container mx-auto">
                <div id="client-reviews" class="carousel slide mx-auto mt-4 mb-4">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <a href="/images/pereezd_magazina/IMG_20170630_103830.jpg" data-toggle="lightbox" data-gallery="review-photo">
                                <img class="d-block" src="/images/pereezd_magazina/IMG_20170630_103830.jpg" alt="Фото 1">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a href="/images/pereezd_magazina/IMG_20180531_131410.jpg" data-toggle="lightbox" data-gallery="review-photo">
                                <img class="d-block" src="/images/pereezd_magazina/IMG_20180531_131410.jpg" alt="Фото 2">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a href="/images/pereezd_magazina/IMG_20180531_131414.jpg" data-toggle="lightbox" data-gallery="review-photo">
                                <img class="d-block" src="/images/pereezd_magazina/IMG_20180531_131414.jpg" alt="Фото 3">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a href="/images/pereezd_magazina/IMG_20180531_132241.jpg" data-toggle="lightbox" data-gallery="review-photo">
                                <img class="d-block" src="/images/pereezd_magazina/IMG_20180531_132241.jpg" alt="Фото 4">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a href="/images/pereezd_magazina/IMG_20180531_132246.jpg" data-toggle="lightbox" data-gallery="review-photo">
                                <img class="d-block" src="/images/pereezd_magazina/IMG_20180531_132246.jpg" alt="Фото 5">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a href="/images/pereezd_magazina/IMG_20180531_133402.jpg" data-toggle="lightbox" data-gallery="review-photo">
                                <img class="d-block" src="/images/pereezd_magazina/IMG_20180531_133402.jpg" alt="Фото 6">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a href="/images/pereezd_magazina/IMG_20180531_133435.jpg" data-toggle="lightbox" data-gallery="review-photo">
                                <img class="d-block" src="/images/pereezd_magazina/IMG_20180531_133435.jpg" alt="Фото 7">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a href="/images/pereezd_magazina/IMG_20180531_133745.jpg" data-toggle="lightbox" data-gallery="review-photo">
                                <img class="d-block" src="/images/pereezd_magazina/IMG_20180531_133745.jpg" alt="Фото 8">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a href="/images/pereezd_magazina/IMG_20180531_134415.jpg" data-toggle="lightbox" data-gallery="review-photo">
                                <img class="d-block" src="/images/pereezd_magazina/IMG_20180531_134415.jpg" alt="Фото 9">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a href="/images/pereezd_magazina/IMG_20180531_152920.jpg" data-toggle="lightbox" data-gallery="review-photo">
                                <img class="d-block" src="/images/pereezd_magazina/IMG_20180531_152920.jpg" alt="Фото 10">
                            </a>
                        </div>
                    </div>

...
<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part3.php'); ?>
    <h1>Организация переездов в Петергофе</h1>
    ...
    <main class="petergof">
        ...
        <div class="js-long-text container">
            <div class="row">
                <p class="col-12 paragraph">
                    Наша компания специализируется на оказании услуг офисного и квартирного переезда в Петергофе под ключ, предлагая клиентам индивидуальный подход для решения персональных задач, качественные материалы и необходимый транспорт. Мы также предоставляем возможность отдельно заказать грузчиков и арендовать машину для перевозки мебели или оргтехники как в дневное, так и ночное время. Работая с нами, вы избежите рисков порчи имущества и непредвиденных растрат. Любые ценные вещи будут доставлены в нужное место в срок в полной сохранности!
                </p>
            ...
            <div class="row">
                <div class="col-md-4 d-flex align-content-center range-of-services">
                    ...
                    <div class="service d-inline-block">
                        Переезд квартиры и офиса в Петергофе и за его пределы
                    </div>
                </div>
                <div class="col-md-4 d-flex align-content-center range-of-services">
                    <div class="h-100 d-inline-block check-mark">
        ...
        <div class="container wrap-garant">
            ...
            <div class="row">
                ...
                <p class="garant col-lg-9">
                    Отсутствие посредников, а также наличие собственного автопарка в Петергофе позволяет нам придерживаться выгодной ценовой политики. Вам не придется платить за подачу машины внушительную цену, поскольку расходы на бензин в нашем случае сведены к минимуму. Услуги от компании «Переезд без Хлопот» недорого обойдутся клиенту с любым уровнем дохода.
                </p>
            </div>
        </div>
        ...
        <div class="container wrap-kv-gorod">
            <h2 class="_header-3 text-center mb-4">
                ...
                <span class="important">Петергоф</span><br>
                <span class="red-bold">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 d-flex align-items-center">
                    Для переезда под ключ, а также перевозки мебели или оргтехники в г. Петергоф клиенту предоставляется Газель-фургон с длиной кузова 3 м, объемом 10 м3 и 2 грузчика на 4 часа работы. Это время будет рационально потрачено на тщательную упаковку вашего имущества, разбор громоздкой мебели, погрузку вещей в машину, транспортировку к месту назначения и расстановку предметов.
                </div>
            </div>
        </div>
        <!--////Benefits/////////////////////////////////////////////////////////////////////////////////////////////-->
            ...
            <div class="row">
                <div class="col-lg-3 benefit1 benefit container">
                    <div class="row">
                        ...
                        <p class="h-hint col-12 text-center">Доступные цены на квартирные переезды по Петергофу</p>
        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-12 text-center">
                    <p class="text-left">
                        К Вашим услугам - организация переезда в Петергофе любого уровня сложности. Перевезем вещи в удобное для Вас время. Закажите переезд под ключ в нашей компании!
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid header-main-theme _call-to-action mb-5">
            <div class="row justify-content-center">
                <h3 class="_header-3 text-center mb-3">
                    ...
                    переезд в
                    <span class="important"> Петергофе </span>
                    сейчас!
                </h3>

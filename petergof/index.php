            ...
            <div class="row">
                <div class="col-lg-3 benefit1 benefit container">
                    <div class="row">
                        ...
                        <p class="h-hint col-12 text-center mainBlueColor">Действительно низкие цены на переезд в Петергофе</p>
                    </div>
                </div>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Яна Мельникова</h5>
                            <p class="text-left text-lg-center">
                                Ваши профессионалы проделали для нас колоссальную работу – перевезли вещи с двухкомнатной квартиры меньше, чем за 3 часа. Очень порадовала вежливость персонала, видно, что вы отбираете лучших!
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала квартирный переезд из Петергофа в Стрельну
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Ирина Лесовая</h5>
                            <p class="text-left text-lg-center">
                                К нам проявили настоящее человеческое отношение, при этом нашего содействия вообще не понадобилось. Машина приехала в отведенный промежуток времени, грузчики в спецформе с полным набором инструментов, вежливые и отзывчивые. Спасибо вам за качественную услугу!
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала переезд из Марьино в Петергоф
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Марина Касьянова</h5>
                            <p class="text-left text-lg-center">
                                У нас переезд прошел отлично и все благодаря опытным рабочим и грамотному руководству вашей компании. Разборку шкафов выполнили быстро, мелкие предметы были тщательно упакованы по коробкам, стеклянные вещи были погружены с особым отношением. Спасибо! Мы довольны.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала квартирный переезд по Петергофу
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Игорь Королев</h5>
                            <p class="text-left text-lg-center">
                                Мне пришлось дважды столкнуться с переездом, и только работая с вами, я получил качественный сервис, заплатив адекватные деньги. Ваши менеджеры – отзывчивые люди, а грузчики – настоящие профи. Особенно понравилась пунктуальность – машина была подана точно в оговоренное время.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал офисный переезд по Петергофу
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Вадим Дергачев</h5>
                            <p class="text-left text-lg-center">
                                Очень рад, что выбрал вашу компанию. Рабочие – серьезные люди, трудяги, не ноют, не затягивают время. В итоге перевезли мебель быстро и без поломок. Спасибо парням за проделанную работуи менеджерам за личные консультации.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал перевозку мебели по Петергофу
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Андрей Иванченко</h5>
                            <p class="text-left text-lg-center">
                                Ваши ребята тщательно отнеслись к перевозке нашей мебели, которой больше 50 лет. Ни царапинки, ни поломки. Спасибо большое. Успехов в вашей работе и процветания. Компании с таким серьезным подходом к делу как у вас просто бесценны!
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывал переезд из Петергофа в Ломоносов
                                    </i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Вероника Смирнова</h5>
                            <p class="text-left text-lg-center">
                                Остался доволен сотрудничеством с вашей компанией. У рабочих вся необходимая оснастка под рукой, плюс большой выбор упаковок, так что каждый предмет упаковали по всем правилам безопасности.
                            </p>
                            <div class="transportation-parameters">
                                <p class="param">
                                    <i class="b-param">
                                        Заказывала перевозку мебели из Петергофа в Малое Коновалово
                                    </i>
                                </p>
                            </div>
                        </div>

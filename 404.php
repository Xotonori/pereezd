...
<link rel="canonical" href="https://pereezdy-spb.ru/404"/>
...
<h1>Неприятная новость</h1>
<?php include_once  ($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'header' . DIRECTORY_SEPARATOR . 'header-part4.php'); ?>

<main class="page-404">
    <div class="container">
        <div class="big-red text-center mb-2 mt-5">404</div>
        <p class="text-center mb-5">Запрошенную информацию найти не удалось.</p>
    </div>
</main>

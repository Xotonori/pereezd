...
<main>
            ...
            <div class="col-11 js-long-text container how-much-description">
                <div class="row">
                    <p class="col-12 paragraph">
                        Мы поможем организовать переезд выставки в сжатые сроки с высоким качеством. Перевозка экспонатов и оборудования осуществляется при соблюдении строгих норм безопасности. Наши грузчики осуществят сборку оборудования на новом месте, помогут с размещением элементов экспозиции. Мы гарантируем бережное обращение с хрупкими предметами и художественными ценностями. Перевозка выставки выполняется на мебельных фургонах. Наличие в кузовах специальных креплений надежно обеспечивает безопасность имущества заказчика в процессе транспортировки.
                    </p>
    ...
    <div class="professional-relocation container">
        <div class="row d-flex justify-content-center">
            <div class="col-12 text-center">
                <h2 class="_header-3"><span class="important">Проф подход</span> в пеерезде выставки</h2>
            </div>
            <div class="col-11">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5><a href="#">Перевозка музейных экспонатов</a></h5>
                        <p>
                            Качественно упакуем предметы старины, бережно перенесем, погрузим/выгрузим, надежно зафиксируем в кузове во избежание падений и ударов при транспортировке
                        </p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img data-src="/images/pereezd-vystavki/103td.png" class="d-block mx-auto" alt="слайд">
                    <div class="carousel-caption d-none d-md-block">
                        <h5><a href="#">Перевозка картин</a></h5>
                        <p>
                            Осуществляем транспортировку художественных полотен в рамах и тубусах. При необходимости изготовим индивидуальную упаковку для картин нестандартных размеров
                        </p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img data-src="/images/pereezd-vystavki/1yur.png" class="d-block mx-auto" alt="слайд">
                    <div class="carousel-caption d-none d-md-block">
                        <h5><a href="#">Монтаж и демонтаж</a></h5>
                        <p>
                            Произведем разборку и сборку выставочных стендов, а также вспомогательного оборудования и мебели с использованием профессионального инструмента.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-11 text-center">
                <h2 class="_header-3 mt-3"><span class="important">Сколько стоит</span> переезд выставки</h2>
            </div>
            <div class="col-11 js-long-text container how-much-description">
                <div class="row">
                    <p class="col-12 paragraph">
                        Стоимость услуг зависит от количества и типа транспортируемого имущества, а также объема и состава заказываемых работ: упаковка, разборка-сборка, расстановка по местам и т.д. Дешевле всего перевозка выставки обойдется, если мы предоставим только транспорт. Расчет цены в каждом случае производится индивидуально, по фиксированным тарифам.
                    </p>
                    <div class="col d-flex justify-content-end">
                        <button class="js-podrobno">
                            <span>Подробно</span>
            ...
            <div class="col-11 js-long-text container how-much-description">
                <div class="row">
                    <p class="col-12 paragraph text-left">
                        Мы достаточно часто выполняем заказы на переезды выставок различного масштаба и профиля. Накопленный опыт помогает нам быстро и качественно справляться с любыми задачами – от помощи в организации художественной экспозиции, до обустройства площадок для представления промышленной продукции. Экономия времени в сочетании с грамотно организованными производственными процессами и налаженной логистикой позволяет нам поддерживать тарифы на минимальном уровне.
                    </p>

...
<meta name="description" itemprop="description" content="Утилизация бытовой техники специалистами компании Переезд Без Хлопот в Санкт-Петербурге" />
...
<main class="utilizaciya-butovoy-tehniki">
    <!--////PAGE-DESCRIPTION/////////////////////////////////////////////////////////////////////////////////////////////-->
    <div class="container">
            ...
            <div class="col-11 js-long-text container how-much-description mt-4">
                <div class="row">
                    <p class="col-12 paragraph pt-0">
                        Бытовая техника в принципе не рассчитана на бесконечный срок эксплуатации. Ее ресурс относительно невелик, а ремонтопригодность изначально закладывается на самом низком уровне. Именно поэтому утилизация бытовой техники в Санкт-Петербурге – злободневный вопрос, решением которого занимаются многие организации. В их числе – наша компания. Мы накопили большой опыт и с радостью проконсультируем вас, решим возникшие проблемы такого рода. Утилизация крупной бытовой техники в условиях мегаполиса требует профессионального подхода, и мы готовы предоставить вам профессиональные и максимально недорогие услуги.
                    </p>
    ...
    <div class="container wrap-kv-gorod">
        <h2 class="_header-3 text-center mb-4">
            Утилизация <span class="important">бытовой техники</span> с грузчиками<br>
            <span class="red-bold">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 d-flex align-items-center">
                Наши специалисты осуществят транспортировку и утилизацию бытовой техники недорого, быстро и аккуратно. Наши услуги доступны по всей Ленинградской области, мы готовы приехать в любой район Санкт-Петербурга за 15-20 минут, а также выполнить ваш заказ в любой день недели и время суток.
            </div>
        </div>
    </div>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p class="text-left text-lg-center">
                            Мы заказывали в вашей фирме утилизацию старой бытовой техники - холодильника. Самим было не справиться. Ваши грузчики сделали все в два приема: вынесли и вывезли. Осталось только купить новый холодильник, современный. С вами общаться комфортно, дело свое знаете. Спасибо!
                        </p>
                        <i>Заказывала утилизацию холодильника</i>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p class="text-left text-lg-center">
                            С вашего сайта заказала утилизацию стиральной машинки. Кстати, очень удобно и понятно. Мы с дочерью одни живем. Нам в любом случае не справиться. Машинка перестала работать, да и старая совсем. По стоимости – нормально, не много. С вами приятно иметь дело!
                        </p>
                        <i>Заказывал утилизацию стиральной машины</i>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p class="text-left text-lg-center">
                            Просто так нельзя сейчас выбрасывать стиральную машину - столько материалов, химии, металлов. Заказала вывоз и утилизацию бытовой техники. Время – вечером после работы. Грузчики приехали, как договаривались, отсоединили машинку и вынесли тихо и спокойно, даже не ожидала. Спасибо за работу!
                        </p>
                        <i>Заказывала утилизацию стиральной машины</i>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p class="text-left text-lg-center">
                            Накопилось много: газовая плита, холодильник и старый компьютер. Решил все разом вывезти. Ваша помощь неоценима, спасибо! Я сэкономил много драгоценного времени.
                        </p>
                        <i>Заказывал утилизацию холодильника, стиральной машины, оргтехники</i>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p class="text-left text-lg-center">
                            Хорошее дело делаете. Все правильно. Старую технику выбрасывать нельзя. Некуда уже, вокруг городов свалки, даже в области. Но ведь и вторсырье тоже ценность. Сам ищу работу и немного вам завидую. Вы вывезли мою газовую плиту на утилизацию, правда за это я заплатил, но это правильно. Вот за это моя благодарность!
                        </p>
                        <i>Заказывал утилизацию газовой плиты</i>
                    </div>
                </div>

...
<button type="button" class="request-call" data-toggle="modal" data-target="#header-modal">Заказать переезд банка</button>
    ...
    <div class="container wrap-benefits">
        <div class="row">
            <div class="col-12 text-center">
                <h2 class="_header-3">За что <span class="important">нас выбирают</span> клиенты</h2>
            </div>
        </div>
        <div class="row">
